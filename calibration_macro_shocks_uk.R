...
#Sweden
EqQ75<-c(1.61, 5.34, 5.11,  5,   5.26)
EqM<-c(1.61, 3.15, 3.89, 3.64, 3.95)
...
Sqr[1]<-GA@solution[1,2]
Sq[1]<-fq(theta,p,GA@solution[1,1],Sqr[1])
Sqc[1]<-GA@solution[1,1]
nu<-GA@solution[1,3]


Sqc[1]<-(4.59832-0.0)/1.2
Sqr[1]<-(6.86017+0.0)/1.2
