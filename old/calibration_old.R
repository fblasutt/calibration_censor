...
f<-function(x,the,k,pr) {
  ...
  -Sq[k]+(((Sqr[k]/x)^(1/the))/((Sqr[k]/x)^(1/the)+pr))*Sqr[k]+
      (1-(((Sqr[k]/x)^(1/the))/((Sqr[k]/x)^(1/the)+pr)))*x}
